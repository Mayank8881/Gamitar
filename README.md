A real-time multiplayer web application where players can place Unicode characters on a shared 10x10 grid. Each player gets exactly one move per game session, creating a collaborative art experience.
